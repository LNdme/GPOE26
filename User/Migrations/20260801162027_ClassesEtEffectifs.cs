...
{
    /// <inheritdoc />
    public partial class ClassesEtEffectifs : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JoinEnabled = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SchoolClasses_AppUsers_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClassEnrollments_AppUsers_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SchoolClasses_TeacherId_SchoolYear",
                table: "SchoolClasses",
                columns: new[] { "TeacherId", "SchoolYear" });
        }
